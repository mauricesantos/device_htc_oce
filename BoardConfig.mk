...
BOARD_KERNEL_CMDLINE := user_debug=31 ehci-hcd.park=3 cma=32M@0-0xffffffff androidboot.hardware=qcom loop.max_part=7 androidboot.selinux=permissive
...
# IPA
USE_DEVICE_SPECIFIC_DATA_IPA_CFG_MGR := false
